...
<html>
	<head>
		<title>AlHaRbi StoR</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<link rel="stylesheet" href="https://azozztmp.com/download/AzozzTMP.css" >
		<link rel="stylesheet" href="assets/css/main.css" />
		 <link rel="stylesheet" href="http://azozztmp.com/download/AzozzTMP.css">
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css">
      <link rel="stylesheet" href="http://cdn.framework7.io/css/framework7-icons.css">
	</head>
	<body>
			<section id="header">
				<header>
				...
				<footer>
					<a href="#banner" class="button style2 scrolly-middle">For App Plus</a>
				</footer>
		</section>
...
<img class="imgae-apps" src="image/store.png">
</div>
<div class="info-apps">
<h4 style="color: #eb9316;" class="title-apps"> AlHRBiStore</h4>
...
<div class="box-apps animated bounce">
<div class="bushafi-az">
<img class="imgae-apps" src="image/snapchat.png">
</div>
<div class="info-apps">
...
<a class="azozz" href="" role="button" data-toggle="modal" data-target="#scospoof">تثبيت</a>
		...
		<section id="footer">
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; BAE88. All rights reserved.</li><li>Design: <a href="http://bae88.tk">Kali</a></li>
				</ul>
			</div>
		</section>
